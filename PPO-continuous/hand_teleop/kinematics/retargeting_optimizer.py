...
class PositionRetargeting(RetargetingBase):
    def __init__(self, robot: sapien.Articulation, 
        ...
        self.optimizer = PositionOptimizer(robot, robot_name, target_joint_names, target_link_names, huber_delta=0.02)
        ...
        # print('first')
        # print(self.last_qpos)

    # @timeit
    def retarget(self, target_pos, fixed_qpos):
        # print('----')
        # print(self.last_qpos)
        # fixed_qpos is 6D vector of fixed base(if we choose fixed base)
