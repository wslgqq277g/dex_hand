...
class InspireRelocateRLEnv(RelocateEnv, BaseRLEnv):
    ...
    def reset(self, *, seed: Optional[int] = None, return_info: bool = False, options: Optional[dict] = None):
        ...
        # self.object_episode_init_pose = self.object_episode_init_pose * sapien.Pose(random_pos, random_quat)quaternion
        # self.object_episode_init_pose = self.object_episode_init_pose * sapien.Pose(random_pos, quaternion[0])
        # print(self.object_episode_init_pose,'ssss')
        # self.object_episode_init_pose = sapien.Pose(q=quaternion[0])
